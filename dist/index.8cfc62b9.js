...
search();
console.log(`i am a normal js`);
(0, _moduleJsDefault.default)();
const hi = "hi";
console.log(hi.toUpperCase());
console.log(_moduleJs.quantity);
if (module.hot) module.hot.accept();

},{"./module.js":"dxpzB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime/runtime":"dXNgZ"}],"dxpzB":[function(require,module,exports) {
// console.log(`i am a module`);
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "amount", ()=>amount) // export { understandingModule };
;
parcelHelpers.export(exports, "quantity", ()=>quantity);
exports.default = function() {
    console.log(`i am a modules`);
};
const amount = 23;
const quantity = 45;
